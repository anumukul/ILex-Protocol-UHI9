...
export function hookAddress() {
  return process.env.NEXT_PUBLIC_ILEX_HOOK_ADDR as `0x${string}`;
}

export function poolManagerAddress() {
  return process.env.NEXT_PUBLIC_POOL_MANAGER_ADDR as `0x${string}`;
}
